  ...
  return <div className="font-sans text-[#0E0E0F] bg-white min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          duration: 0.6
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <div className="flex items-center gap-2 text-white bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                <MapPin size={18} />
                <span className="font-medium">Live Fleet Tracking</span>
              </div>
              <div className="flex items-center gap-2 text-white bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                <TrendingUp size={18} />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            description: 'Real-time technician location tracking for every service call. Fleet managers see live GPS updates showing which vehicles are being serviced, when, and by whom—complete visibility across your NYC operation.'
          }, {
            icon: DollarSign,
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0E0E0F] mb-4">
              What NYC Fleet Managers Say
            </h2>
            <p className="text-lg text-[#555A60] max-w-3xl mx-auto">
              Real feedback from commercial operations across New York City
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[{
            name: 'Tom K.',
            location: 'Logistics Manager, Long Island City',
            rating: 5,
            text: 'We run 15 delivery vans in Queens and Manhattan. These guys service our entire fleet on-site at our depot. Fast response, professional work, and they understand the pressure of keeping vehicles on the road in NYC.'
          }, {
            name: 'Maria S.',
            location: 'Operations Director, Brooklyn',
            rating: 5,
            text: 'Manage a fleet of 20 vehicles for our catering company. Mobile Battery Guys handles all our battery needs—from emergency replacements to scheduled maintenance. They track our fleet health and prevent problems before they happen.'
          }, {
            name: 'James P.',
            location: 'Fleet Supervisor, Manhattan',
            rating: 5,
            text: 'Our black car service has 30+ vehicles operating 24/7. When a battery dies, downtime costs us money. These technicians respond fast, work efficiently in tight garage spaces, and get our drivers back on the road quickly.'
