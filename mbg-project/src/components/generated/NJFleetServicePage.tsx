  ...
  return <div className="font-sans text-[#0E0E0F] bg-white min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          duration: 0.6
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <div className="flex items-center gap-2 text-white bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                <MapPin size={18} />
                <span className="font-medium">Live Dispatch Tracking</span>
              </div>
              <div className="flex items-center gap-2 text-white bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
                <Calendar size={18} />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            description: 'Local account manager who understands North Jersey logistics. They know Routes 1, 3, 46, and the Turnpike—and your business. Plus live technician tracking so you always know service status.'
          }, {
            icon: DollarSign,
            ...
            description: 'Payment is required to confirm service and dispatch technicians. Streamlined invoicing and flexible payment terms for established commercial accounts.'
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0E0E0F] mb-4">
              What North Jersey Fleet Managers Say
            </h2>
            <p className="text-lg text-[#555A60] max-w-3xl mx-auto">
              Trusted by commercial operations throughout North Jersey
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[{
            name: 'Robert M.',
            location: 'Operations Manager, Carlstadt',
            rating: 5,
            text: 'Our warehouse runs 12 trucks daily. Mobile Battery Guys services our fleet at our Carlstadt facility. They\'re reliable, know the area well, and their preventive maintenance program has saved us from costly breakdowns.'
          }, {
            name: 'Linda H.',
            location: 'Fleet Director, Paramus',
            rating: 5,
            text: 'We operate a 25-vehicle landscaping fleet across Bergen County. These guys handle all our battery needs—from emergency calls to scheduled replacements. Fair pricing and they understand the demands of running a Jersey business.'
          }, {
            name: 'Steve D.',
            location: 'Dispatch Manager, Jersey City',
            rating: 5,
            text: 'Run 18 delivery vans for our wholesale operation. When a battery dies, every minute costs money. These technicians respond fast, work efficiently, and get our drivers back on their routes quickly. Great partner for our Hudson County operation.'
