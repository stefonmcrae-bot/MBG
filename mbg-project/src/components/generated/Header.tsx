  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#0E1117]/95 backdrop-blur-sm shadow-lg' : 'bg-transparent'}`}>
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a href="/book" className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-white/20 transition-all border border-white/20">
              <Battery size={18} />
              Book Now
            </a>
            <a href="tel:6466527085" className="inline-flex items-center gap-2 bg-gradient-to-r from-[#007BFF] to-[#18DBF1] text-white px-6 py-3 rounded-xl font-bold hover:shadow-xl transition-all">
              <Phone size={20} />
              646-652-7085
            </a>
          </div>
      ...
      <AnimatePresence>
        ...
        height: 0
            ...
            window.dispatchEvent(new PopStateEvent('popstate'));
            window.scrollTo(0, 0);
          }} className="flex items-center justify-center gap-2 bg-white border-2 border-[#007BFF] text-[#007BFF] px-6 py-3 rounded-xl font-bold mt-3">
                <Battery size={20} />
                Book Online
              </a>
            </div>
