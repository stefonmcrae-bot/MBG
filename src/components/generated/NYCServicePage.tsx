        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          duration: 0.6
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-[#0E1117]">Anywhere in NYC</span>
            </h1>

            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto leading-relaxed">
              We come to your location in Manhattan, Brooklyn, Queens, Bronx, or Staten Island. Professional battery installation at your home, office, or curbside.
            </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            icon: Home,
            title: 'At Your Home',
            description: 'Battery replacement in your driveway, apartment parking, or street parking'
          }, {
            icon: Building2,
            title: 'Office Buildings',
            description: 'Service in office parking garages and lots throughout Manhattan and all boroughs'
          }, {
            icon: MapPin,
            title: 'Parking Garages',
            description: 'We work in NYC parking structures and garages—no need to move your car'
          }, {
            icon: Car,
            title: 'Curbside Service',
            description: 'Stranded on the street? We come to you and replace your battery on-site'
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-3">
                    {['Free battery testing and diagnostics', 'New premium battery installation', 'Charging system inspection', 'Terminal cleaning and protection', 'Old battery disposal', 'Warranty on parts and labor', 'Same-day service available', '30-45 minute service time'].map(item => <li key={item} className="flex items-center gap-3">
