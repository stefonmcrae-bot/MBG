        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          duration: 0.6
            ...
            <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto leading-relaxed">
              Fast mobile jump start service at malls, train stations, your home, office, or anywhere in North Jersey
            </p>
                ...
                <div>
                  ...
                  <div className="mt-6 p-4 bg-[#F5F7FA] rounded-lg">
                    <p className="text-sm text-[#555A60]">
                      <strong className="text-[#0E0E0F]">Need a Battery Replacement?</strong> If your battery won\'t hold a charge, we also offer mobile battery replacement service anywhere in North Jersey.
                    </p>
                  </div>
                </div>
              </div>
